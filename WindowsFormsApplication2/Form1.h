...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {this->fileToolStripMenuItem, 
				this->openToolStripMenuItem, this->viewToolStripMenuItem, this->helpToolStripMenuItem});
			...
			// 
			this->openToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {this->copyToolStripMenuItem, 
				this->pasteToolStripMenuItem, this->pasteToolStripMenuItem1, this->undoToolStripMenuItem, this->redoToolStripMenuItem});
			this->openToolStripMenuItem->Name = L"openToolStripMenuItem";
			this->openToolStripMenuItem->Size = System::Drawing::Size(39, 20);
			this->openToolStripMenuItem->Text = L"Edit";
			// 
			...
			this->pasteToolStripMenuItem->Text = L"Cut";
			// 
			// pasteToolStripMenuItem1
			// 
			this->pasteToolStripMenuItem1->Name = L"pasteToolStripMenuItem1";
			this->pasteToolStripMenuItem1->Size = System::Drawing::Size(152, 22);
